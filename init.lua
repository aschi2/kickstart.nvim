...
do
  ...
  -- Buffer, visual-indent and move-text keymaps
...
do
  ...
  -- Automatic project-root cwd
  require('mini.misc').setup {}
  MiniMisc.setup_auto_root()

  -- Mini file explorer with toggle on \\
  require('mini.files').setup {}
  local minifiles_toggle = function(...)
    if not MiniFiles.close() then MiniFiles.open(...) end
  end
  vim.keymap.set('n', '\\', minifiles_toggle, { desc = 'Toggle mini.files' })
...
do
  ...
  require('telescope').setup {
    -- Open the current results in trouble.nvim with <c-t>
    -- (trouble is added later by the custom plugin loader, so require lazily)
    defaults = {
      mappings = {
  ...
  vim.keymap.set('n', '<leader><leader>', function() require('telescope').extensions.smart_open.smart_open() end, { desc = '[ ] Smart open' })
...
do
  ...
  require('conform').setup {
    ...
    format_on_save = function(bufnr)
      ...
      -- Format on save for everything except these filetypes
...
do
  ...
  -- runtimepath (base vim.snippet does the expansion; no LuaSnip needed).
...
do
  ...
  local parsers = {
    ...
    'regex', 'rust', 'python', 'go', 'yaml', 'json', 'svelte', 'dockerfile', 'javascript', 'typescript', 'just', 'helm',
  }
